...
import { X, TagIcon, CheckCircle2, Circle, Edit, Trash2, Plus, Loader2 } from 'lucide-vue-next';
...
const emit = defineEmits(['close', 'toggle-task', 'edit-subtask', 'delete-task', 'add-subtask']);
...
<template>
    <div
        ...
        class="fixed inset-y-0 right-0 z-50 w-full overflow-auto transform bg-white shadow-2xl transition-transform duration-300 ease-in-out md:w-2xl lg:w-2xl"
    ...
    >
        ...
        <div class="flex-1 overflow-y-auto p-4">
            ...
            <div class="border-t pt-4">
                ...
                <!-- Subtask Form Slot - Add this line -->
